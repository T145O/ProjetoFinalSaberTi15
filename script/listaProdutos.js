...
function renderizar(produtos) {
    ...
    produtos.forEach(p => {
        ...
        statusCell.textContent = p.status_produto;
        statusCell.style.color = p.status_produto === "ATIVO" ? "green" : "red";
        statusCell.style.fontWeight = "bold";

        // Coluna de Ações com o link estilizado como botão
        const acoesCell = row.insertCell();
        const linkEditar = document.createElement("a");
        linkEditar.href = `editarProduto.html?id=${p.produtoid}`;
