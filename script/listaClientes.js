...
async function carregarClientes() {
    ...
    listaClientesTableBody.innerHTML = '<tr><td colspan="4">Carregando clientes...</td></tr>';
...
function renderizarClientes(clientes) {
    ...
    if (clientes.length === 0) {
        listaClientesTableBody.innerHTML = '<tr><td colspan="4">Nenhum cliente encontrado.</td></tr>';
        return;
    }
